...
roof_panel_9 : new Dom("roof_panel_9"),
  ...
  steps: [
    ...
    (step4 = function () {
      ...
      Scenes.setStepHeading(
        "Step 4",
        "Add Internal Soffit, External Soffit and Wedge Pin to complete the one side of Wall ."
      );
    ...
    (step5 = function () {
      ...
      Scenes.setStepHeading(
        "Step 5",
        "Placing Back Right Wall and Fornt Left Wall in the lab."
      );
      // todo remove all previous
      Scenes.items.contentAdderBox.setContent("");
      ...
      let menuItemAnimes = [
         ...
         ()=>{
          ...
          anime({
            ...
            duration: 2000,
            complete(){
              setCC("Click on the 'Front Left wall' to add Front Left wall in the lab.");      
              Dom.setBlinkArrow(true, left, right+50).play();
            }
          })
        },
      ...
      setCC("Click on the 'Back Right wall' to add Back Right wall in the lab.");      
      Dom.setBlinkArrow(true, left, right).play();
    // setCC("Click 'Next' to go to next step");
        //   Dom.setBlinkArrow(true, 790, 408).play();
        //   setIsProcessRunning(false);
        //   anime({
    ...
    (step6 = function () {
      ...
      Scenes.setStepHeading(
        "Step 6",
        "Placing the Front wall parts, CT Prop, Top Panel, Wall Soffit to setting up the front right wall."
      );
      // todo remove all previous
      Scenes.items.contentAdderBox.setContent("");
      ...
      let menuItemAnimes = [
         ...
         ()=>{
          ...
          anime({
            ...
            duration: 2000,
            complete(){
              setCC("Click on the 'CT Prop' to add CT Prop in the lab.");      
              Dom.setBlinkArrow(true, left, right+50).play();
            }
          })
        },
         ...
         ()=>{
          ...
          anime({
            ...
            duration: 2000,
            complete(){
              setCC("Click on the 'Top Panel' to add Top Panel in the lab.");      
              Dom.setBlinkArrow(true, left, right+100).play();
            }
          })
        },
         // top panel anime
         ()=>{
          ...
          anime({
            ...
            duration: 2000,
            complete(){
              setCC("Click on the 'Wall Soffit' to add Wall Soffit in the lab.");      
              Dom.setBlinkArrow(true, left, right+150).play();
            }
          })
        },
         // wall soffit anime
      ...
      setCC("Click on the 'Front Right Wall' to add Front Right Wall in the lab.");      
      Dom.setBlinkArrow(true, left, right).play();
    // setCC("Click 'Next' to go to next step");
        //   Dom.setBlinkArrow(true, 790, 408).play();
        //   setIsProcessRunning(false);
    ...
    (step7 = function () {
                    ...
                    complete(){
                      anime({
                        ...
                        complete(){
                          ...
                          Dom.setBlinkArrow(true, 745,15).play();
                        }
                      })
                    }
                  })
          ...
          anime({
            ...
            complete(){
              anime({
                ...
                duration: 2000,
                complete(){
                  setCC("Click on the 'Panel' to add Panel in the lab.");      
                  Dom.setBlinkArrow(true, 745,65).play();
                }
              })
            }
          })
      ...
      setCC("Click on the 'CT Prop' to add CT Prop in the lab.");      
      Dom.setBlinkArrow(true, 745,-35).play();
    // setCC("Click 'Next' to go to next step");
        //   Dom.setBlinkArrow(true, 790, 408).play();
        //   setIsProcessRunning(false);
        //   anime({
