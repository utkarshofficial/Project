...
function setCC(text = null, speed = null) {
  ...
  var typed2 = new Typed(ccDom, {
    stringsElement: text,
    typeSpeed: 20,
    backSpeed: 0,
  });
  // ccDom.innerHTML = text;
  return ccDom;
}
                              ...
                              anime
                                ...
                                .add({
                                  ...
                                  complete() {
                                    ...
                                    setCC(" Calculate the cross-sectional area of bar using above formula.")
      ...
      Scenes.domItems.tempInputBtn.onclick = function () {
        ...
        if (s0 != 59.4) {
          ...
          anime
            ...
            .add({
              targets: [Scenes.img.s0formula2.img, text, Scenes.domItems.tempInputBox],
              opacity: 0,
              complete() {
                Img.hideAll();
              },
...
;
    ...
    (s15 = function () {
      ...
      } - ${currentDate.getFullYear()}<br>Grade of Steel:       550 SD steel`;
